...
public class ImageCacheManager{
	 ...
	 * @param quality
	 */
	public void init(Context context, int cacheSize, CompressFormat compressFormat, int quality, CacheType type){
		switch (type) {
		case DISK:
			mImageCache= new DiskLruImageCache(context, compressFormat, quality);
			break;
		case MEMORY:
			mImageCache = new BitmapLruImageCache(cacheSize);
		case MEMORY_DISK:
		default:
			mImageCache = new BitmapDoubleCache(context, cacheSize, compressFormat, quality);
			break;
		}
