package com.autotiming.csck.netapi.image;
...
import com.autotiming.csck.utils.ClientPathManager;
...
public class DiskLruImageCache implements ImageCache  {
    ...
    private static int diskCacheSize = 50*1024*1024; //50M
    ...
    private File getDiskCacheDir(Context context) {
        ...
        final String cachePath = ClientPathManager.getImgCachePath();
    ...
    public void putBitmap( String key, Bitmap data ) {
        ...
        try {
            editor = mDiskCache.edit( ImageCacheManager.createKey(key) );
            if ( editor == null ) {
                return;
            }
    ...
    public Bitmap getBitmap( String key ) {
        ...
        try {
            ...
            snapshot = mDiskCache.get( ImageCacheManager.createKey(key) );
            if ( snapshot == null ) {
                return null;
            }
